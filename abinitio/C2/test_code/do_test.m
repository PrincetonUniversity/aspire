function [cl_detec_rate,rank1_rate,err_in_degrees] = do_test(nImages,snr,is_use_weights_third_row,is_use_weights_inplane)
...
shift_step_1d = 0.5;
projSize = 89;
[projs,refq] = generate_c2_images(nImages,snr,projSize,'SYNTHETIC',max_shift,shift_step_2d);
...
cl_detec_rate = cl_detection_rate(clmatrix,n_theta,min_dist_cls,refq);
...
[Rijs,Rijgs,rank1_rate,isRank1_ijs] = local_sync_J(Rijs,Rijgs,nImages);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
