function [J_sync,J_significance,eigenvalues,itr,dd] =...
    cryo_syncDn_Jsync_power_method (Rij , n_eigs , scores_as_entries , verbose , measure_time )
...
%
% Originally based on cryo_sync3n_Jsync_power_method.m, line 80
% was changed to support signs_times_v_mex_Dn.c (instead of
% signs_times_v_mex,c).
%
% Written by Ido Greenberg, 2015.
% Revised by Yoel Shkolnisky, March 2016.
% Modified by Elad Eatah, April 2021.
...
while itr < MAX_ITERATIONS && dd > epsilon
    itr = itr + 1;
    [vec_new,n_cores] = signs_times_v_mex_Dn(N,Rij,vec,n_eigs,scores_as_entries,pairs_scores,0);
