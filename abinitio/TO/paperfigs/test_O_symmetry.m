% Test the function cryo_abinitio_TO using simulated noisy data with O symmetry
%
% https://www.ebi.ac.uk/empiar/EMPIAR-10272/
% 
% Generate output files for O symmetry.
% The figures of the paper are generated from these output files using the function plot_results_O.m
%
...
for Nprojs=[25, 50, 100, 200]
    ...
    for k=1:numel(snr_list)
        ...
        t_start = tic;
        cryo_abinitio_TO('O',projs_fname,vol_fname,...
            'O_symmetry_1068_candidates_cache_080222.mat',params_fname);
