...
tables_ref=load('cryo_orient_projections_tables_ref.mat');
tables_cpu=load('cryo_orient_projections_tables_cpu.mat');
...
tables_ref=load('cryo_orient_projections_tables_ref.mat');
tables_gpu=load('cryo_orient_projections_tables_gpu.mat');
