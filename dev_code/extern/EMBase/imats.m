function numdrawn=imats(ImageStack, scale, startlabel, MenusOn)
% function numdrawn=imats(ImageStack,scale, startlabel, MenusOn)
% Display a stack of images as a tiled display, autoscaled.
%  Only the first
% argument is required. startlabel gives the starting number labeling an
% image (default is 1).  Use MenusOn=1 (default is 0) if you want to have the
% ability to print or save the figure.  The returned variable tells how
% many images were drawn.
