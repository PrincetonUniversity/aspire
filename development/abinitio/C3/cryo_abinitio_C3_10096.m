...
%% Load projections
projs_10096 = ReadMRC('/home/yoel/scratch/10096/aspire/averages_nn50_group1_sorted_contrast.mrc');
projs_10097 = ReadMRC('/home/yoel/scratch/10097/aspire/averages_nn50_group1_sorted_contrast.mrc');

nImages_10096 = size(projs_10096,3);

projs = cat(3,projs_10096,projs_10097);
clear projs_10096;
clear projs_10097;
...
log_message('using %d images of 10096, and %d images of 10097', ...
    numel(find(im_indeces <= nImages_10096)),numel(find(im_indeces > nImages_10096)));
