function [estR,estdx,vol2aligned,reflect]=cryo_align_densities_C3(vol1,vol2,pixA,verbose,Rref,forcereflect,Nprojs)
...
if verbose
    ...
    if refgiven
        ...
        log_message('Estimation error (Frobenius norm) up to C3 element ||Rest.'' - g^s Rref.''||= %5.3e for s=%d', m,s);
    end
end
estR=Rest;
...
if refgiven
    % Rotate Rest by the estimated C3 element to best align it with Rref.
    Rest=(g^(-s)*Rest.').';
