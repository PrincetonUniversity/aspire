function [images,refq,ref_shifts] = generate_c3_images(nImages,SNR,projSize,c3_type,max_shift,shift_step)
%
...
if ~exist('c3_type','var')
    c3_type = 'Gaussian';
end

refq   = qrand(nImages);

log_message('loading simulated %s volume',c3_type)
if strcmp(c3_type,'GAUSSIAN')
    vol = cryo_gaussian_phantom_3d('C3_params',projSize,1);   
else
    error(['no such c4_type : ' c3_type]);
end
