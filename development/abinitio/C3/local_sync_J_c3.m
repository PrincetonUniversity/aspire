function [vijs,viis,im_inds_to_remove,pairwise_inds_to_remove,npf,projs,refq,ref_shifts] = local_sync_J_c3(Rijs,Riis,npf,...
...
for i=1:nImages
    ...
    for j=i+1:nImages
        ...
        JRjjJ_T = J*Rjj.'*J;
        Rjj_g       = Rjj.';
        c_Rjj = {Rjj, JRjjJ, Rjj_g, JRjjJ_T, Rjj, JRjjJ, Rjj_g, JRjjJ_T};
