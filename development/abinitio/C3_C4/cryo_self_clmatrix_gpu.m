function [sclmatrix,correlations,shifts] = cryo_self_clmatrix_gpu(npf,max_shift,shift_step,...
                                            is_handle_equator_ims,equator_res_fact,equator_fraction,refq)
% Input parameters:
...
% [90,180] but all 180 apart lines are perfectly correlated so we set it to
% be smaller.
