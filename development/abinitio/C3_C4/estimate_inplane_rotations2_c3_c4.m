function [rots,in_plane_rots] = estimate_inplane_rotations2_c3_c4(n_symm,npf,vis,inplane_rot_res,max_shift,shift_step)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% !!!!!!!This function is obsolete!!!!!!!!. Should replace it with
% estimate_inplane_rotations_cn (not sure that is the name...)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
assert(mod(n_theta_ij,n_symm)==0);
...
for i = 1:nImages
    ...
    for j = i+1:nImages
        ...
        H(i,j) = cos(n_symm*theta_diff) + sqrt(-1)*sin(n_symm*theta_diff);
...
for i  = 1:nImages
    ...
    c   = real(zi^(1/n_symm));  % we have n_symm time the desired angle
    s   = -imag(zi^(1/n_symm)); % we have n_symm time the desired angle
