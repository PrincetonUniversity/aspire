% path(pathdef);
% run('/home/gabip/matlabProjects/mycode/initpath.m');

% disp('REMOVE THESE LINES AFTER FIX FROM YOEL');
% addpath('/home/yoel/data/work/aspire/development/extern/EMIO/');
...
run('/home/gabip/matlabProjects/aspire/aspire/install_cims_nufft.m');
