...
ciis = zeros(10,nRisTilde,'uint16');
...
cijs = zeros(nRisTilde,nRisTilde,n_theta_ij/12,12,2,'uint16');
msg = [];
for i=1:nRisTilde
    Ri_tilde = Ris_tilde(:,:,i);
    ...
    for j=1:nRisTilde
        ...
        c_1s = reshape(c_1s,n_theta_ij/12,12);
        c_2s = reshape(c_2s,n_theta_ij/12,12);
