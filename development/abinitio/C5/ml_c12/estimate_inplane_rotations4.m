...
%         t1 = clock;
        ...
        corrs = reshape(corrs,n_theta_ij/12,12,nshifts);
        ...
        H(i,j) = cos(12*theta_diff) + sqrt(-1)*sin(12*theta_diff);
%            
%         %%%%%%%%%%%%%%%%%%% debug code %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         
%         t2 = clock;
...
for i  = 1:nImages
    ...
    c   = real(zi^(1/12));  % we have four time the desired angle
    s   = -imag(zi^(1/12)); % we have four time the desired angle
