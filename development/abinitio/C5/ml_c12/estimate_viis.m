function [all_self_corrs,viis,mse_vii] = estimate_viis(ciis,Ris_tilde,npf,max_shift,shift_step,shift_phases,is_handle_equators,refq)
...
all_self_corrs = zeros(numel(inds_scl1),nImages);
