...
E = [  
      1     1/12  1/12   1/12      0.4*cosd(0*360/5)      0.4*sind(0*360/5)       0      0     0      0;
      1     1/12  1/12   1/12      0.5*cosd(0*(360/5)+7) 0.5*sind(0*(360/5)+7)  0      0     0      0;
      
      1     1/12  1/12   1/12      0.4*cosd(1*360/5)      0.4*sind(1*360/5)      0      0     0      0;
      1     1/12  1/12   1/12      0.5*cosd(1*(360/5)+7) 0.5*sind(1*(360/5)+7) 0      0     0      0;
      
      1     1/12  1/12   1/12     0.4*cosd(2*360/5)      0.4*sind(2*360/5)       0      0     0      0;
      1     1/12  1/12   1/12     0.5*cosd(2*(360/5)+7) 0.5*sind(2*(360/5)+7)  0      0     0      0;
      
      1     1/12  1/12   1/12     0.4*cosd(3*360/5)      0.4*sind(3*360/5)       0      0     0      0;
      1     1/12  1/12   1/12     0.5*cosd(3*(360/5)+7) 0.5*sind(3*(360/5)+7)  0      0     0      0;
      
      1     1/12  1/12   1/12     0.4*cosd(4*360/5)      0.4*sind(4*360/5)       0      0     0      0;
      1     1/12  1/12   1/12     0.5*cosd(4*(360/5)+7) 0.5*sind(4*(360/5)+7)  0      0     0      0;
