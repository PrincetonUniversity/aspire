function [vijs,viis,max_corrs_stats,mse_vij,detec_rate] = ...
    compute_third_row_outer_prod_both(npf,ciis,cijs,Ris_tilde,R_theta_ijs,max_shift,shift_step,is_handle_equators,refq,is_viz_cls)
...
[all_self_corrs,viis] = estimate_viis(ciis,Ris_tilde,npf,max_shift,shift_step,shift_phases,is_handle_equators,refq);
