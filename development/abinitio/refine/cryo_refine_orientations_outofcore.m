function [rots_refined,shifts_refined,errvec]=cryo_refine_orientations_outofcore(projs_fname,isFT, vol,rots,shifts,verbose,Nrefs,true_Rs,true_shifts)
...
if isFT
    projs_hat_fname=projs_fname;
else
    % Compute polar Fourier transform of the projections
    % Parameters for polar Fourier transform
...
if ~isFT % The polar Fourier transform was computed in this function
