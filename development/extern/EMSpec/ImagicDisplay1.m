function numdrawn=ImagicDisplay1(ImageStack, scale, startlabel, MenusOn)
% function numdrawn=ImagicDisplay(ImageStack,scale, startlabel, MenusOn)
% Make an EMAN-like, resizable display of the image stack in the current
...
h=gcf;
SetGrayscale;
set(h,'Units','pixels','ResizeFcn',@Redraw,'Toolbar','none');
if MenusOn
