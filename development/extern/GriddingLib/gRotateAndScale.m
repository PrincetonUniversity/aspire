function mr=gRotateAndScale(m,theta,mag,kernelsize)
% function [mr,rft]=grotate(m,theta,mag[,kernelsize]);
% 2D rotation and scaling using the fast gridding algorithm of Penczek.
...
[n n1]=size(m);
if mod(n,8)
    error('gRotateAndScale: size of input must be a multiple of 8');
end;
