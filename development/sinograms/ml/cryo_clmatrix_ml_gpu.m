function [clstack,coststack,shift_equations,shift_equations_map,clstack_mask]=...
    cryo_clmatrix_ml(pf,M,KNN,noise_cov,max_itr,verbose,max_shift,shift_step,...
...
[S,~,Zi]=cryo_cld_ml_ws_gpu(spf,n_theta,M,KNN,max_itr,noise_cov,1,max_shift,shift_step);
