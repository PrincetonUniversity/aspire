...
extern inline size_t GSL_MAX_INT (size_t a, size_t b);
extern inline size_t GSL_MIN_INT (size_t a, size_t b);
...
GSL_MAX_INT (size_t a, size_t b)
{
  return GSL_MAX (a, b);
}

extern inline size_t
GSL_MIN_INT (size_t a, size_t b)
{
  return GSL_MIN (a, b);
}
