 ...
 * exceptions: none
 */
double gsl_poly_eval(const double c[], const size_t len, const double x);
 ...
 */
size_t gsl_poly_solve_quadratic (double a, double b, double c, 
                              double * x0, double * x1);
 ...
 * Roots are returned ordered.
 */
size_t gsl_poly_solve_cubic (double a, double b, double c, 
