// defs-env.h 2010-03-18,21:51:42
...
extern sof io_mem_free(void *p, cchar *, cint, cchar *);
extern sof io_mem_print(cchar *, cint, cint);
extern sof io_mem_usage(cchar *, cint, cint);
extern sof io_mem_info(cvoid *, cchar *, cint, cchar *);
extern sof io_mem_chat(cint);
