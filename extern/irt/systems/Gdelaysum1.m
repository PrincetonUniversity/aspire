...
case 'fatrix2'
	odim = arg.Ny*arg.Nm;
	forw = @(arg, x) delaysum1_mex('delaysum1,forw', arg.h, arg.delay, ...
		arg.nthread, single(x), int32(arg.Ny));
	back = @(arg, y) delaysum1_mex('delaysum1,back', arg.h, arg.delay, ...
		arg.nthread, single(y));
