% function y=icfft2e(x)
%
% Aliased IFFT2 of the 2D array x, assuming that both the spatial sampling
% points and the frequnecy sampling points are symmetric around 0.
% The IFFT is computed using O(nlogn) operations.
%
% x   The 2D sequence whose IFFT should be computed. 
%     Can be of odd or even length. Must be a 2D array.
%
% Returns the aliased IFFT of the 2D sequence x.
%
