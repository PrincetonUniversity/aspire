function [pf,freqs]=pft(p,n_r,n_theta,precision)
%
...
%   12/22/2009   Call to nufft_t_prepare_v3 was replaced with a call to
%                nufft_t_2d_prepare. Call to nufft_t_v3 was replaced with a
%                call to nufft_t_2d_execute.
%
