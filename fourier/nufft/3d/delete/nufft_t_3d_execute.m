function g=nufft_t_3d_execute(x,prepdata)
%
% See nufft_t_3d_prepare.
%
% Yoel Shkolnisky, January 2009.
%
% Filename changed from nufft_t3_execute to nufft_t_3d_execute. (Y.S.
% December 22, 2009).


g=nufftt3dexecutemx(x,prepdata);
