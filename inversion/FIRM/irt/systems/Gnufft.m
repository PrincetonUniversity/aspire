...
% Gnufft_gram_Fatrix()
%
function [T, reuse] = Gnufft_gram_Fatrix(ob, W, reuse)
T = nufft_gram(ob, W);
...
% Gnufft_gram_fatrix2()
%
function [T, reuse] = Gnufft_gram_fatrix2(ob, W, reuse)
T = nufft_gram(ob, W);
T = Gmatrix(T, ... % trick: this is a kludge (todo: improve)
