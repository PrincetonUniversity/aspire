function [h, meanh] = CTF_old(n, res, lambda, defocus, Cs, B, alpha)
...
meank2=-pi*lambda*mean(defocus)*1e4*f0^2;
%meanh=(meank2*r2+k4*r2.*r2-alpha).*exp(-kr*r2);
meanh=(meank2*r2+k4*r2.*r2-alpha).*exp(-kr*r2);
