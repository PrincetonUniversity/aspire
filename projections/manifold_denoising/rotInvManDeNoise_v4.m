function [ projections_man_den,projections_svs_den,projections_sPca,rndPermIdx] = rotInvManDeNoise_v4( filePath,beta,T,N,nImSMH,maxEigIdx,useSPCA,useWienerFilt,shuffle,nImCV,olN,nn_p)
%
...
vCell = smhExtNystrom(PSWF_coeff_denSVS,vCell,dCell,nImSMH,ang_freqs,W_eps,nTheta,0,0);
...
trainSize = round(trainPart*nImages);
