function [projections, noisy_projections, shifts, q] = ...
    gen_projections_v2(K,SNR,max_shift,step_size,noise_type,silent,fprecomp)
%
% Like gen_projections but modified slighly to be aligned with the new
% projection code to within double precision. 
%
...
if (precomp==0)
    ...
    %volref=cryo_gaussian_phantom_3d('C1_params',65,1);
% Another volume
%    load vol129
