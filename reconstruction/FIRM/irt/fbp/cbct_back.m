...
if extrapolate_t, fail 'extrapolation not done for mex yet', end
...
%	im(back0), return
	...
	if 0 % check extrapolator
		tmp = cbct_back(args{:}, 'use_mex', 0, 'extrapolate_t', 1);
		im plc 1 3
		im(1, back0)
		im(2, tmp)
		im(3, tmp - back0)
