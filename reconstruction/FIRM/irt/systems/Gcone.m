...
%|
%| option
%|	'type'		'sf1' : separable footprint by Yong Long (default)
%|				other sf variations are possible: sf2 etc.
...
%|			(dividing line for rectangle and trapezoid approximation)
...
if arg.use_hct2
	...
	arg.hct2.m = [test_dir 'gcone-hct-mask.fld'];
	arg.hct2.name = 'hct2';
...
x = flipper3(x, arg);
x = permute(x, [3 1 2 4]); % trick: dd1|dd2|nn1|pd1 mex code wants z dim first!
...
x = permute(x, [2 3 1 4]); % trick: dd1|dd2|nn1|pd1|sf123 code puts z dim first!
x = flipper3(x, arg);
...
fld_write(arg.hct2.m, arg.ig.mask, 'check', 0); % write mask
