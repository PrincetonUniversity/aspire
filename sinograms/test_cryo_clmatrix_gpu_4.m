...
%
% Compare cryo_clmatrix to cryo_clmatrix_gpu bit by bit.
...
[clstack_gpu,corrstack_gpu,shift_equations_gpu,shift_equations_map_gpu]...
    = cryo_clmatrix_gpu(pf,K,1,max_shift_1d,shift_step_1d);
t_gpu=toc;
tic;
[clstack_cpu,corrstack_cpu,shift_equations_cpu,shift_equations_map_cpu] ...
    = cryo_clmatrix(pf,K,1,max_shift_1d,shift_step_1d);
t_cpu=toc;
