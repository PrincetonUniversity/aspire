%function [xopt,fopt,niter,gnorm,dx] = grad_descent_yuan(hatv, maxL)
...
% F3d1 = reshape(F1,nx,nx,nx); 
% figure()
% plot(F3d1(R+1:end,R+1,R+1));
% clear F1;
% hatv = F3d1;
...
title('Condition number of the transformation matrix as maxL increases','FontSize',15);
...
%%
err_rel = max(abs(a-x)) %6.352115089789261e-14
