...
%}
function [ X_out , obj_value, runtime ] = NUG_2dregis_noJ( numIter , coeff, tS2 )
...
obj_value = cellfun(@(x,y) trace(x*y), C, X_out, 'UniformOutput',false);
obj_value = sum(cell2mat(obj_value));
