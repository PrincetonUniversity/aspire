function coeffMat = SO3FT_inBatches( objVal , bandlmt , t , n , objVal_subI , objVal_subJ )
...
for k = 0:t
    ...
    coeff_k = SO3FT_objVal( ((-k):k)+t+1 , ((-k):k)+t+1 , : ) .* repmat( W_beta , 1 , 1 , length(objVal_subI) );
    ...
    for row = 1:dk
        ...
        idx = sub2ind( [n*dk,n*dk] , (objVal_subI-1)*dk+row , (objVal_subJ-1)*dk+col ); % useful indices
