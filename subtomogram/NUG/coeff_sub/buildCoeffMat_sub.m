...
%}
function coeffMat = buildCoeffMat_sub( pf , bandlmt , t , K_sub, ns, b_sub, n_theta, numCompThreads )
...
objVal = getObjVal_sub( P , alpha , beta, gamma , K_sub, ns, b_sub, n_theta, numCompThreads );
