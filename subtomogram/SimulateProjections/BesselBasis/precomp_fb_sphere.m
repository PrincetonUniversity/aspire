function [ basis, sample_points, maxL ] = precomp_fb_sphere( n_r, R, c, ss, maxL)
%%% Description
...
if ~exist('maxL','var')
    [basis, maxL] = Bessel_ns_radial_sphere(c, R, r, ss);
else
    [basis, maxL] = Bessel_ns_radial_sphere(c, R, r, ss, maxL);
end
end
